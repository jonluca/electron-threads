...
const initMessageTimeout =
  typeof process !== "undefined" && typeof process.env !== "undefined" && process.env.THREADS_WORKER_INIT_TIMEOUT
...
function setPrivateThreadProps<T>(
  ...
  return Object.assign(raw as T & PrivateThreadProps, {
    [$errors]: workerErrors,
    [$events]: workerEvents,
    [$terminate]: terminate,
    [$worker]: worker,
 ...
 *
 * @param worker Instance of `Worker`. Either a web worker, `worker_threads` worker
 * @param [options]
